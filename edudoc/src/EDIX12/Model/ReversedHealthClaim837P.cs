...
namespace EDIX12.Models
{
    ...
    /// </summary>
    public class ReversedHealthClaim837P
    {
        ...
        public class ClaimInformation_Loop2300
        {
            ...
            #region Line Item Control Number Loop 2300

            [EdiValue(Path = "REF/0", Description = "REF01 - Reference ID Qualifier - 6R")]
            public string ReferenceReversed { get; set; }

            [EdiValue(Path = "REF/1", Description = "REF02 - Line Item Control Number")]
            public string LineItemControlNumberReversed { get; set; }
            ...
            //public ReferingProvider_Loop2010BB ReferingProvider2 { get; set; }
