...
namespace Model
{
    ...
    public partial class AuthUser: IEntity, IAuthUser
    {
        // AuthUser
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [Column(@"Id", Order = 1, TypeName = "int")]
        [Index(@"PK_AuthUsers", 1, IsUnique = true, IsClustered = true)]
        [Key]
        [Display(Name = "Id")]
        ...
        [Column(@"HasLoggedIn", Order = 10, TypeName = "bit")]
        [Display(Name = "Has logged in")]
        public bool HasLoggedIn { get; set; } // HasLoggedIn
