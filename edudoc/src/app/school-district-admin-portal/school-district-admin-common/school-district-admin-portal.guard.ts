...
@Injectable()
export class SchoolDistrictAdminPortalGuard  {
    ...
    canActivate(): Observable<boolean> {
        ...
        if (currentUser && currentUser.CustomOptions.UserTypeId === UserTypesEnum.SchoolDistrictAdmin) {
            return of(true);
        } else {
            // this.notificationsService.info('Only School District Admins can access the school district admin section');
