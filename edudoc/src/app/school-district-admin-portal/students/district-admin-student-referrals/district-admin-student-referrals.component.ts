...
@Component({
    selector: 'app-district-admin-student-referrals',
    templateUrl: './district-admin-student-referrals.component.html',
})
export class DistrictAdminStudentReferralsComponent implements OnInit {
    ...
    private buildSearch(): ExtraSearchParams[] {
        ...
        _extraSearchParams.push(
            new ExtraSearchParams({
                name: 'DistrictId',
                value: this.userService.getAdminDistrictId().toString(),
            }),
        );
