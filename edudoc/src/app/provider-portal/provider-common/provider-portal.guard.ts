...
@Injectable()
export class ProviderPortalGuard  {
    ...
    canActivate(): Observable<boolean> {
        ...
        if (currentUser && currentUser.CustomOptions.UserTypeId === UserTypesEnum.Provider) {
            return of(true);
        } else {
            // this.notificationsService.info('Only Providers can access the provider section');
