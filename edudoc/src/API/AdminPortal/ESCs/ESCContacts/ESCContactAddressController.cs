...
{
    [Route("api/v1/escs/{districtId:int}/contacts/{contactId:int}/address")]
    [Restrict(ClaimTypes.ESCs, ClaimValues.FullAccess | ClaimValues.ReadOnly)]

    public class ESCContactAddressController : ApiControllerBase
    {
        private readonly IAddressService _addressService;

        public ESCContactAddressController(IAddressService addressService)
        {
